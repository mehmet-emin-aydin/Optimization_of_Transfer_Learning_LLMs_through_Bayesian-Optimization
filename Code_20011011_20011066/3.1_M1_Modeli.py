...
def load_and_process_data(file_path):
    ...
    with open(file_path, "r") as file:
        lines = [line.strip("__label__sports") for line in file.readlines()]
...
file_path = "sports_843648_lines.txt"  # Veri setinin dosya yolu
...
training_args = TrainingArguments(
    hub_model_id="eminAydin/turkish-gpt2-mini-M1-cleaned-sports720k-10ep",
