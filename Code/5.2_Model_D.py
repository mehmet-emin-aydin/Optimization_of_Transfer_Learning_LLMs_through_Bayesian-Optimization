...
CONTEXT_LENGTH = 512
model = AutoModelForCausalLM.from_pretrained("eminAydin/turkish-gpt2-mini-M1-cleaned-sports720k-10ep")
...
training_args = TrainingArguments(
    hub_model_id="eminAydin/Turkish-GPT2-mini-ModelD",
...
trainer.train()
trainer.push_to_hub("eminAydin/Turkish-GPT2-mini-ModelD")